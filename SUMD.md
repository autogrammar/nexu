...
# nexu | 122f 24808L | python:116,shell:3,javascript:2,less:1 | 2026-06-03
# stats: 891 func | 21 cls | 122 mod | CC̄=4.8 | critical:87 | cycles:0
# alerts[5]: CC test_cinema_player_template_is_externalized=93; CC test_render_server_script_embeds_runtime_context=80; CC test_import_http_project_fetches_and_migrates=35; CC test_import_zip_project_creates_markpact_migration_and_options=22; CC test_render_server_script_embeds_project_import_routes=20
# hotspots[5]: test_projects_import_zip_endpoint fan=33; test_iterate_dashboard_kinds_colors_prefers_offline_before_llm fan=32; test_iterate_colors_scope_uses_offline_path fan=31; test_cinema_server_imports_markpact_upload fan=30; test_iterate_colors_scope_uses_llm_patch_when_available fan=30
# evolution: baseline
# Keys: M=modules, D=details, i=imports, e=exports, c=classes, f=functions, m=methods
M[122]:
  app.doql.less,202
  deploy/docker/cinema_serve.py,54
  examples/backend_service/app/users.py,9
  examples/calculator_demo/scientific_calculator_demo.py,62
  examples/calculator_demo/scientific_calculator_demo2.py,87
  examples/frontend_view/src/menu_icons.py,25
  examples/lane_integration/realtime_lane_nexu_sync.py,63
  examples/markpact_integration/nexu_markpact_exporter.py,96
  examples/mcp_patch_demo/server.js,88
  examples/mcp_service/src/demo.py,11
  examples/runner/run_examples.py,80
  examples/vertical_slice/src/flow.py,10
  examples/web_app_calculator/cinema/nexu_hooks.py,354
  examples/web_app_calculator/cinema/server.py,3478
  ...
  src/nexu/cinema_dom_patch.py,28
  src/nexu/cinema_goal_contracts.py,396
  src/nexu/cinema_history.py,245
  src/nexu/cinema_html.py,17
  src/nexu/cinema_html_validate.py,206
  src/nexu/cinema_http_preprocess.py,688
  ...
  src/nexu/cinema_offline_options.py,902
  src/nexu/cinema_options_cache.py,129
  src/nexu/cinema_policy.py,915
  src/nexu/cinema_project_imports.py,1684
  src/nexu/cinema_projects.py,721
  src/nexu/cinema_publish.py,633
  src/nexu/cinema_scope.py,254
  src/nexu/cinema_scripts.py,713
  ...
  tree.sh,2
D:
  deploy/docker/cinema_serve.py:
    e: main
    main()
  examples/backend_service/app/users.py:
    e: list_users
    list_users(filters;users)
  examples/calculator_demo/scientific_calculator_demo.py:
    e: main
    main()
  examples/calculator_demo/scientific_calculator_demo2.py:
    e: print_code,main
  ...
  examples/lane_integration/realtime_lane_nexu_sync.py:
    e: simulate_realtime_sync
    simulate_realtime_sync()
  examples/markpact_integration/nexu_markpact_exporter.py:
    e: main
    main()
  examples/mcp_service/src/demo.py:
    e: plan_demo
    plan_demo(user_goal)
  examples/runner/run_examples.py:
    e: run_example,main
    run_example(example)
    main()
  ...
  examples/web_app_calculator/cinema/nexu_hooks.py:
    e: apply_manifest_from_ledger,verify_capsule,apply_spatial_patch,propose_llm,append_policy_entry,append_goal_policy_entry,goal_contract_lines,validate_artifact,save_history,list_history,restore_history,effective_ui_constraints,sync_option_previews,patch_option_previews,projects_catalog,activate_project,import_project_from_zip,import_project_from_git,import_project_from_http,import_project_from_markpact,delete_imported,delete_workspace_project,imported_markpact,imported_llm_log,active_project,export_markpact_readme,services_catalog,publish_service,start_service,stop_service,delete_service
    ...
    effective_ui_constraints(stage;focus_scope)
    sync_option_previews(stage;delete_ids)
    patch_option_previews(stage;session_keep;session_delete;focus_scope)
    projects_catalog()
    ...
    import_project_from_markpact(filename;content_base64)
    delete_imported(project_id)
    delete_workspace_project(project_id)
  ...
  examples/web_app_calculator/cinema/server.py:
    e: _load_cinema_ui_profile,_goal_entry_kwargs,_llm_prompt_intro,_llm_prompt_rules,_llm_communication_contract_block,_load_env_file,_load_all_env,_resolve_model,_llm_network_allowed,_litellm_available,_llm_status_payload,_trace_slug,_read_trace_index,_write_llm_trace,_list_llm_traces,_path_segments,_parse_imported_project_route,_delete_imported_project,_delete_project,_imported_markpact,_imported_llm_log,_read_llm_trace,_ensure_api_key_env,_strip_markdown_fences,_extract_html_document,_compact_html_for_llm,_effective_markpact_mode,_compact_markpact_for_llm,_try_read_options_cache,_store_options_cache,_extract_llm_content,_compact_llm_error,_load_policy_payload,_apply_entry_constraints,_effective_ui_constraints_from_ledger,_update_constraints,_merge_ui_constraints,_ensure_intract_on_path,_propose_cinema_contracts,_proposal_kind_and_element,_proposal_delta_text,_normalize_proposals_for_ledger,_append_policy_entry_legacy,_nexu_hooks_apply,_nexu_hooks_verify,_propose_llm_for_stage,_validate_intract_artifact,_append_policy_entry,_save_history_checkpoint,_list_history,_restore_history,_sync_option_previews,_patch_option_previews,_projects_catalog,_active_project,_activate_project,_import_project,_import_project_zip,_import_project_git,_import_project_http,_import_project_markpact,_parse_multipart_upload,_parse_multipart_zip,_parse_multipart_markpact,_export_markpact_markdown,_services_catalog,_publish_service,_start_service,_stop_service,_delete_service,_IterateHandler,_IterateHandler,CustomHTTPRequestHandler,ThreadingHTTPServer
    _IterateHandler: __init__(4),_load_policy_payload(0),_load_goal_contract_lines(0),_merge_ui_constraints(0),_compute_marked_llm_context(0),_apply_scope_fragment(0),_determine_apply_flags(0)  # Encapsulates iteration request handling to reduce complexity
    _IterateHandler: __init__(2),handle(0),_parse_request_data(0),_restore_http_import_stages_if_needed(0),_read_current_stage_html(0),_build_llm_context(0),_determine_iteration_mode(0),_execute_iteration(0),_execute_options_mode(0),_execute_options_llm(3),_execute_full_llm_options(5),_execute_active_workspace_mode(0),_log_iteration(0),_sync_options(0),_append_policy_entry(0),_validate_intract_artifact(0),_save_history_checkpoint(0),_send_response(0),_build_llm_prompt(0),_apply_spatial_patch(2),_finalize_llm_html(1),_call_llm(2),_parse_batch_options(1),_generate_parallel_options(1),_build_batch_options_prompt(1),_call_llm_batch_options(1),_try_llm_patch_options(1),_try_intract_fast_options(0),_try_function_patch_options(0),_llm_option_variants(3),_write_option_files(2)  # Helper class to handle the /iterate endpoint logic, reducing
    CustomHTTPRequestHandler: __init__(0),_handle_get_root_redirect(0),_handle_get_policy(0),_handle_get_projects_catalog(0),_handle_get_projects_active(0),_handle_get_services_catalog(0),_handle_get_health(0),_handle_get_llm_status(0),_handle_get_llm_traces(0),_handle_get_imported_project_route(0),_handle_get_llm_trace(0),_handle_get_history(0),_handle_get_export_markpact(0),do_GET(0),_handle_post_log(1),_handle_post_manifest_apply_ledger(1),_handle_post_capsule_verify(0),_handle_post_propose_llm(1),_handle_post_propose_goal(1),_handle_post_history_restore(1),_handle_post_services_publish(1),_handle_post_services_start(1),_handle_post_services_stop(1),_handle_post_services_delete(1),_handle_post_projects_activate(1),_handle_post_projects_import(1),_handle_post_projects_import_zip(1),_handle_post_projects_import_git(1),_handle_post_projects_import_http(1),_handle_post_projects_import_markpact(1),_handle_post_projects_delete(1),_handle_post_promote(1),_handle_post_iterate(1),do_POST(0),do_DELETE(0),do_OPTIONS(0)
    ThreadingHTTPServer:
    ...
    _effective_ui_constraints_from_ledger(ledger;stage;focus_scope)
    _update_constraints(state;elements;value)
    ...
    _patch_option_previews(stage;session_keep;session_delete;focus_scope)
    _projects_catalog()
    _active_project()
    ...
    _import_project_markpact(content;filename)
    _parse_multipart_upload(post_data;content_type)
    _parse_multipart_zip(post_data;content_type)
    _parse_multipart_markpact(post_data;content_type)
  ...
  src/nexu/cinema_goal_contracts.py:
    ...
    _build_contract_context(goal;focus_scope;focus_scope_label;current_state;expected_version;project_context;project_kind;capsule_name;stage)
    _create_main_target_proposal(capsule_name;stage;ctx)
    _create_focus_scope_proposal(capsule_name;stage;ctx)
  ...
  src/nexu/cinema_http_preprocess.py:
    ...
    _load_organize_patch_context(source_dir;organize)
    _local_source_rel_path(path)
    _read_http_source_artifacts(source_dir;meta)
    _build_http_artifacts_payload()
  ...
  src/nexu/cinema_project_imports.py:
    e: http_stage_matches_import,reject_import_stage_replacement,http_cinema_files_match_import,restore_http_import_stages_if_needed,_slug,_imports_root,_project_dir,_validate_http_url,_validate_git_url,_safe_extract_zip,_charset_from_content_type,_decode_http_bytes,_document_base_href,_fetch_http_body,_same_origin,_extract_stylesheet_hrefs,_fetch_http_stylesheets,_rewrite_local_stylesheets,_rewrite_local_asset_refs,_rewrite_organize_extracted_refs,_strip_base_href,_is_cinema_local_ref,_absolutize_external_ref,_parse_srcset,_format_srcset,_absolutize_external_urls,_fetch_meta_assets,_inject_base_href,_find_http_index_path,_load_http_fetch_meta,_http_preview_source_context,_read_http_preview_html,_rewrite_optional_stylesheets,_extract_organize_files,_ensure_http_preview_marker,_build_http_preview_stage0,_iter_project_files,_detect_run_notes,_safe_markpact_rel_path,extract_markpact_embedded_files,_title_from_markpact_content,_write_markpact_embedded_files,_read_text_for_markpact,_build_markpact_migration,_stage_html,_apply_http_preprocess_fields,_refresh_http_preprocess_if_needed,_activate_imported,import_git_project,import_http_project,import_zip_project,import_markpact_project,_import_kind_from_id,_project_title_from_id,_maybe_organize_import_source,_finish_import,_infer_workspace_context,_source_stats,_source_url_from_meta,normalize_imported_project_id,is_deletable_imported_id,_resolve_markpact_path,_with_workspace_meta_defaults,_compile_meta_fields,_ensure_project_meta_fields,_catalog_entry_from_meta,_filter_traces_for_project,read_imported_markpact,imported_project_llm_log,_verify_delete_paths,_activate_delete_fallback,_clear_active_project,_delete_active_project_fallback,delete_imported_project,delete_project,list_imported_projects,merged_projects_catalog,_load_http_import_meta,promote_cinema_option,activate_imported_project
    http_stage_matches_import(html;meta)
    reject_import_stage_replacement(html;meta)
    http_cinema_files_match_import(cinema_dir;meta)
    restore_http_import_stages_if_needed(cinema_dir;meta)
    _slug(value)
    ...
    _rewrite_local_asset_refs(html)
    _rewrite_organize_extracted_refs(html)
    _strip_base_href(html)
    _is_cinema_local_ref(ref)
    _absolutize_external_ref(ref;page_url)
    _parse_srcset(value)
    _format_srcset(items)
    _absolutize_external_urls(html;page_url)
    _fetch_meta_assets(fetch_meta)
    _inject_base_href(html;base_href)
    _find_http_index_path(source_dir)
    _load_http_fetch_meta(source_dir)
    _http_preview_source_context(meta)
    _read_http_preview_html(index_path)
    _rewrite_optional_stylesheets(html)
    _extract_organize_files(meta)
    _ensure_http_preview_marker(html)
    _build_http_preview_stage0(meta)
    _iter_project_files(root)
    _detect_run_notes(root)
    _safe_markpact_rel_path(rel)
    extract_markpact_embedded_files(markdown)
    _title_from_markpact_content(markdown;filename;embedded)
    ...
    import_markpact_project(cinema_dir;filename;content_base64)
    _import_kind_from_id(project_id)
    _project_title_from_id(project_id)
    _maybe_organize_import_source(source_dir;import_kind)
    ...
    _resolve_markpact_path(cinema_dir;project_id;meta)
    _with_workspace_meta_defaults(meta;updated)
    ...
    _load_http_import_meta(cinema_dir;project_id)
    promote_cinema_option(cinema_dir)
  ...
  src/nexu/cinema_publish.py:
    e: _service_url_mode,_public_service_url,services_root,_registry_path,_load_registry,_save_registry,_slug_service_id,_pick_port,_port_open,_http_ok,_service_alive,_refresh_service_status,list_published_services,_write_service_readme,_imported_project_ids_in_html,_bundle_imported_source_assets,_prepare_service_directory,_generate_markpact_export,_allocate_service_port,_create_service_entry,_register_service,_handle_existing_service,publish_project_service,_spawn_http_server,_wait_for_service_running,_find_service_entry,_ensure_service_port,_update_service_entry_for_startup,start_published_service,stop_published_service,_validate_service_id,delete_published_service,delete_published_services_for_project
    _service_url_mode()
    _public_service_url(service_id)
    ...
    _imported_project_ids_in_html(html)
    _bundle_imported_source_assets(cinema_dir;service_dir;html)
    ...
    _find_service_entry(services;service_id)
    _ensure_service_port(entry;services;service_id)
    _update_service_entry_for_startup(entry;services;service_id;port;proc)
    start_published_service(cinema_dir;service_id)
    stop_published_service(cinema_dir;service_id)
    _validate_service_id(service_id)
    delete_published_service(cinema_dir;service_id)
    delete_published_services_for_project(cinema_dir;project_id)
  src/nexu/cinema_scope.py:
    e: cinema_has_offline_baseline,scope_option_variants,scope_meta_for_project,load_cinema_ui_profile,can_use_offline_fast_iterate
  ...
  src/nexu/cinema_scripts.py:
    e: inject_cinema_shield,finalize_cinema_html,write_cinema_inject_files,repair_cinema_html_files
  ...
  tests/test_cinema_dom_patch.py:
    e: test_build_function_option_patches_returns_valid_abc,test_build_function_option_patches_xpatches_delete_marks,test_build_function_option_patches_allows_imported_theme_css,test_function_patch_context_is_compact_ir,test_supports_function_patch_only_for_web_like_projects
    test_build_function_option_patches_returns_valid_abc()
    test_build_function_option_patches_xpatches_delete_marks()
    test_build_function_option_patches_allows_imported_theme_css()
  ...
  tests/test_cinema_html_validate.py:
    e: test_repair_adds_missing_head_and_doctype,test_relocate_style_tags_to_head,test_validate_calculator_requires_screen_and_buttons,test_prepare_rejects_non_html,test_filter_valid_option_batch_requires_all_three,test_validate_css_safety_rejects_flow_breaking_layout_css,test_validate_css_safety_allows_runtime_overlay_css,test_html_validation_rejects_generated_absolute_layout,test_imported_html_validation_allows_original_theme_css
  ...
  tests/test_cinema_http_preprocess.py:
    ...
    test_load_http_preprocess_artifacts_includes_organize(tmp_path)
  ...
  tests/test_cinema_marked_context.py:
    ...
    test_inject_scope_style_colors_kadence_heading_inline_strong()
    test_should_block_full_html_for_imported_marks()
    test_marked_css_selectors_includes_btn_prefix()
  ...
  tests/test_cinema_policy.py:
    e: test_resolve_iteration_mode,test_normalize_manifest_target_defaults_invalid,test_apply_ledger_from_cinema_project_only,test_effective_ui_constraints_from_ledger_last_wins,test_effective_ui_constraints_filters_project_and_scope,test_promote_applies_spatial_deletes_only_for_functions_scope,test_refresh_imported_policy_snapshot_keeps_markpact_separate_from_intract,test_intract_manifest_path_rejects_markpact_readme,test_effective_ui_constraints_ignores_unscoped_when_focus_scope_set,test_merge_ui_constraint_lists_session_overrides_ledger,test_sync_option_previews_empty_delete_ids_mirrors_workspace,test_sync_option_previews_from_workspace,test_enforce_deletes_on_option_previews,test_ensure_option_previews_from_stages,test_propose_ui_delta_and_validate,test_iteration_ledger_contracts_use_active_project_and_scope
    ...
    test_effective_ui_constraints_filters_project_and_scope()
    test_promote_applies_spatial_deletes_only_for_functions_scope()
    test_refresh_imported_policy_snapshot_keeps_markpact_separate_from_intract(tmp_path)
    test_intract_manifest_path_rejects_markpact_readme(tmp_path)
    test_effective_ui_constraints_ignores_unscoped_when_focus_scope_set()
    ...
    test_iteration_ledger_contracts_use_active_project_and_scope(tmp_path)
  tests/test_cinema_project_imports.py:
    e: test_import_zip_project_creates_markpact_migration_and_options,test_merged_projects_catalog_includes_imported,test_delete_project_hides_demo_from_workspace_catalog,test_import_zip_with_index_html_organizes_source,test_import_zip_without_index_html_skips_organize,test_activate_imported_project_reloads_stages,test_validate_urls_reject_file_scheme,test_safe_extract_zip_rejects_unsafe_paths,test_import_http_project_fetches_and_migrates,test_build_http_preview_stage0_serves_extracted_css_from_cinema,test_build_http_preview_stage0_absolutizes_remote_asset_refs,test_import_http_project_uses_rendered_dom_snapshot,test_activate_http_import_regenerates_preview_stage0,test_activate_http_import_regenerates_preprocess_when_missing,test_activate_http_import_empty_subtitle_not_goal,test_activate_zip_import_does_not_require_user_goal,test_activate_imported_project_resets_calculator_ledger,test_import_http_project_requires_network_flag,test_import_git_project_requires_network_flag,test_is_deletable_imported_id,test_delete_imported_http_domain_id_with_dot,test_delete_imported_project_removes_directory,test_extract_markpact_embedded_files_parses_fenced_blocks,test_import_markpact_project_extracts_files_and_activates,test_import_markpact_project_rejects_non_markdown,test_read_imported_markpact_returns_markdown,test_http_stage_matches_import_rejects_calculator_pollution,test_http_stage_matches_import_ignores_nexu_shield_selectors,test_http_cinema_files_match_import_detects_polluted_alt,test_restore_http_import_stages_if_needed_rebuilds_from_seed,test_promote_http_import_restores_polluted_alt_before_copy,test_activate_http_import_after_calculator_pollution
    ...
    test_import_zip_with_index_html_organizes_source(tmp_path)
    test_import_zip_without_index_html_skips_organize(tmp_path)
    ...
    test_build_http_preview_stage0_serves_extracted_css_from_cinema(tmp_path)
    test_build_http_preview_stage0_absolutizes_remote_asset_refs(tmp_path)
    test_import_http_project_uses_rendered_dom_snapshot(tmp_path)
    ...
    test_extract_markpact_embedded_files_parses_fenced_blocks()
    test_import_markpact_project_extracts_files_and_activates(tmp_path)
    test_import_markpact_project_rejects_non_markdown(tmp_path)
    test_read_imported_markpact_returns_markdown(tmp_path)
    test_http_stage_matches_import_rejects_calculator_pollution(tmp_path)
    test_http_stage_matches_import_ignores_nexu_shield_selectors(tmp_path)
    test_http_cinema_files_match_import_detects_polluted_alt(tmp_path)
    test_restore_http_import_stages_if_needed_rebuilds_from_seed(tmp_path)
    test_promote_http_import_restores_polluted_alt_before_copy(tmp_path)
    test_activate_http_import_after_calculator_pollution(tmp_path)
  ...
  tests/test_cinema_publish.py:
    e: cinema_setup,test_publish_creates_service_files,test_list_and_start_stop_service,test_list_migrates_old_localhost_service_urls,test_publish_can_generate_subdomain_public_urls,test_publish_missing_stage_returns_error,test_publish_http_import_bundles_source_assets,test_delete_published_service_removes_registry_and_files,test_delete_unknown_service_returns_error
    cinema_setup(tmp_path)
    test_publish_creates_service_files(cinema_setup)
    test_list_and_start_stop_service(cinema_setup)
    test_list_migrates_old_localhost_service_urls(cinema_setup)
    test_publish_can_generate_subdomain_public_urls(cinema_setup;monkeypatch)
    test_publish_missing_stage_returns_error(cinema_setup)
    test_publish_http_import_bundles_source_assets(tmp_path)
    test_delete_published_service_removes_registry_and_files(cinema_setup)
    test_delete_unknown_service_returns_error(cinema_setup)
  tests/test_cinema_scope.py:
    e: test_dashboard_disallows_keypad_scope,test_calculator_allows_keypad_scope,test_offline_fast_scopes_per_kind,test_dashboard_colors_offline_labels,test_scope_option_variants_dashboard_functions,test_strip_and_inject_scope_style,test_scoped_html_fragment_for_calculator_colors,test_cinema_has_offline_baseline,test_inject_scope_style_calculator_colors,test_load_cinema_ui_profile_from_active_and_stage,test_ui_profile_ignores_runtime_script_tokens,test_can_use_offline_fast_iterate,test_imported_kind_uses_web_scopes,test_http_import_offline_colors_keeps_site_markers,test_http_import_offline_colors_recolors_marked_buttons,test_http_import_offline_colors_respects_keep_marks,test_http_import_offline_orientation_marks_create_two_column_patch,test_http_import_offline_colors_recolors_kadence_heading_inline,test_http_import_offline_colors_recolors_all_marked_kadence_headings,test_http_import_offline_orientation_two_columns_with_delete_marks,test_http_import_offline_display_keeps_entry_content_headings,test_http_import_offline_shapes_keeps_content_button_radii
    ...
    test_http_import_offline_colors_respects_keep_marks(tmp_path)
    test_http_import_offline_orientation_marks_create_two_column_patch(tmp_path)
    test_http_import_offline_colors_recolors_kadence_heading_inline(tmp_path)
    test_http_import_offline_colors_recolors_all_marked_kadence_headings(tmp_path)
    test_http_import_offline_orientation_two_columns_with_delete_marks(tmp_path)
    test_http_import_offline_display_keeps_entry_content_headings(tmp_path)
    test_http_import_offline_shapes_keeps_content_button_radii(tmp_path)
  tests/test_cinema_scripts.py:
    e: test_finalize_strips_truncated_llm_script_and_injects_canonical,test_finalize_marks_web_gui_components_as_selectable_targets,test_inject_cinema_shield_preserves_existing_scripts,test_inject_cinema_shield_posts_compact_marked_fragment,test_inject_cinema_shield_skips_lazy_placeholder_imgs,test_inject_cinema_shield_requires_meaningful_image_alt
  ...
  tests/test_cinema_server.py:
    ...
    test_render_server_script_embeds_project_import_routes()
    test_cinema_server_imports_markpact_upload(tmp_path)
  ...
  tests/test_intract.py:
    e: test_parse_intract_line,test_parse_toon_manifest
    test_parse_intract_line()
    test_parse_toon_manifest(tmp_path)
...
project_file('sdk/js/repatch-sdk.js', 187, 'javascript').
...
project_file('src/nexu/cinema_dom_patch.py', 28, 'python').
project_file('src/nexu/cinema_goal_contracts.py', 396, 'python').
project_file('src/nexu/cinema_history.py', 245, 'python').
project_file('src/nexu/cinema_html.py', 17, 'python').
project_file('src/nexu/cinema_html_validate.py', 206, 'python').
project_file('src/nexu/cinema_http_preprocess.py', 688, 'python').
...
project_file('src/nexu/cinema_offline_options.py', 902, 'python').
project_file('src/nexu/cinema_options_cache.py', 129, 'python').
project_file('src/nexu/cinema_policy.py', 915, 'python').
project_file('src/nexu/cinema_project_imports.py', 1684, 'python').
project_file('src/nexu/cinema_projects.py', 721, 'python').
project_file('src/nexu/cinema_publish.py', 633, 'python').
project_file('src/nexu/cinema_scope.py', 254, 'python').
project_file('src/nexu/cinema_scripts.py', 713, 'python').
...
project_file('src/nexu/intract.py', 47, 'python').
...
project_file('src/nexu/verify.py', 326, 'python').
...
project_file('tests/test_cinema_dom_patch.py', 96, 'python').
project_file('tests/test_cinema_goal_contracts.py', 128, 'python').
project_file('tests/test_cinema_history.py', 50, 'python').
project_file('tests/test_cinema_html_validate.py', 115, 'python').
project_file('tests/test_cinema_http_preprocess.py', 344, 'python').
...
project_file('tests/test_cinema_marked_context.py', 251, 'python').
...
project_file('tests/test_cinema_policy.py', 314, 'python').
project_file('tests/test_cinema_project_imports.py', 960, 'python').
project_file('tests/test_cinema_project_ir.py', 23, 'python').
project_file('tests/test_cinema_projects.py', 206, 'python').
project_file('tests/test_cinema_publish.py', 234, 'python').
project_file('tests/test_cinema_scope.py', 592, 'python').
project_file('tests/test_cinema_scripts.py', 67, 'python').
project_file('tests/test_cinema_server.py', 1126, 'python').
...
project_file('tests/test_intract.py', 49, 'python').
...
python_function('examples/web_app_calculator/cinema/nexu_hooks.py', 'append_policy_entry', 5, 6, 8).
...
python_function('examples/web_app_calculator/cinema/nexu_hooks.py', 'effective_ui_constraints', 2, 2, 3).
python_function('examples/web_app_calculator/cinema/nexu_hooks.py', 'sync_option_previews', 2, 1, 3).
python_function('examples/web_app_calculator/cinema/nexu_hooks.py', 'patch_option_previews', 4, 11, 8).
...
python_function('examples/web_app_calculator/cinema/nexu_hooks.py', 'import_project_from_markpact', 2, 1, 3).
python_function('examples/web_app_calculator/cinema/nexu_hooks.py', 'delete_imported', 1, 1, 4).
python_function('examples/web_app_calculator/cinema/nexu_hooks.py', 'delete_workspace_project', 1, 1, 4).
...
python_function('examples/web_app_calculator/cinema/server.py', '_load_policy_payload', 0, 2, 5).
...
python_function('examples/web_app_calculator/cinema/server.py', '_merge_ui_constraints', 4, 2, 3).
...
python_function('examples/web_app_calculator/cinema/server.py', '_validate_intract_artifact', 3, 3, 1).
python_function('examples/web_app_calculator/cinema/server.py', '_append_policy_entry', 5, 3, 2).
python_function('examples/web_app_calculator/cinema/server.py', '_save_history_checkpoint', 0, 4, 1).
...
python_function('src/nexu/cinema_goal_contracts.py', '_build_contract_context', 9, 11, 5).
python_function('src/nexu/cinema_goal_contracts.py', '_create_main_target_proposal', 3, 2, 1).
python_function('src/nexu/cinema_goal_contracts.py', '_create_focus_scope_proposal', 3, 3, 2).
python_function('src/nexu/cinema_goal_contracts.py', 'propose_goal_extension_contracts', 1, 5, 7).
...
python_function('src/nexu/cinema_html_validate.py', 'validate_cinema_html_document', 1, 9, 14).
...
python_function('src/nexu/cinema_http_preprocess.py', '_load_organize_patch_context', 2, 13, 6).
python_function('src/nexu/cinema_http_preprocess.py', '_local_source_rel_path', 1, 2, 2).
python_function('src/nexu/cinema_http_preprocess.py', '_read_http_source_artifacts', 2, 5, 4).
python_function('src/nexu/cinema_http_preprocess.py', '_build_http_artifacts_payload', 0, 7, 6).
python_function('src/nexu/cinema_http_preprocess.py', 'load_http_preprocess_artifacts', 2, 6, 10).
...
python_function('src/nexu/cinema_policy.py', '_intract_manifest_path', 1, 4, 4).
python_function('src/nexu/cinema_policy.py', '_ledger_entry_matches_project', 1, 8, 5).
python_function('src/nexu/cinema_policy.py', 'promote_applies_spatial_deletes', 1, 2, 3).
python_function('src/nexu/cinema_policy.py', '_ledger_entry_matches_scope', 1, 5, 4).
python_function('src/nexu/cinema_policy.py', '_process_ledger_entry', 3, 6, 6).
...
python_function('src/nexu/cinema_policy.py', '_normalize_html_body', 1, 1, 1).
python_function('src/nexu/cinema_policy.py', '_html_files_distinct', 2, 1, 1).
...
python_function('src/nexu/cinema_policy.py', 'refresh_imported_policy_snapshot', 3, 5, 7).
python_function('src/nexu/cinema_policy.py', '_replace_html_title', 2, 1, 1).
python_function('src/nexu/cinema_policy.py', 'sync_option_previews_from_workspace', 1, 4, 5).
python_function('src/nexu/cinema_policy.py', 'enforce_deletes_on_option_previews', 2, 3, 3).
...
python_function('src/nexu/cinema_policy.py', 'load_effective_ui_constraints', 2, 14, 11).
...
python_function('src/nexu/cinema_policy.py', 'manifest_paths_from_snapshot', 4, 3, 5).
python_function('src/nexu/cinema_policy.py', 'apply_ledger_from_cinema', 2, 6, 10).
python_function('src/nexu/cinema_policy.py', 'ensure_intract_on_path', 1, 5, 5).
python_function('src/nexu/cinema_policy.py', 'propose_ui_delta_contract_dicts', 0, 9, 6).
...
python_function('src/nexu/cinema_policy.py', 'append_iteration_ledger_entry', 2, 3, 7).
...
python_function('src/nexu/cinema_project_imports.py', 'http_stage_matches_import', 2, 10, 9).
python_function('src/nexu/cinema_project_imports.py', 'reject_import_stage_replacement', 2, 7, 5).
python_function('src/nexu/cinema_project_imports.py', 'http_cinema_files_match_import', 2, 8, 4).
python_function('src/nexu/cinema_project_imports.py', 'restore_http_import_stages_if_needed', 2, 6, 8).
...
python_function('src/nexu/cinema_project_imports.py', '_rewrite_local_asset_refs', 1, 6, 6).
python_function('src/nexu/cinema_project_imports.py', '_rewrite_organize_extracted_refs', 1, 9, 6).
python_function('src/nexu/cinema_project_imports.py', '_strip_base_href', 1, 1, 1).
python_function('src/nexu/cinema_project_imports.py', '_is_cinema_local_ref', 1, 5, 3).
python_function('src/nexu/cinema_project_imports.py', '_absolutize_external_ref', 2, 6, 5).
python_function('src/nexu/cinema_project_imports.py', '_parse_srcset', 1, 4, 5).
python_function('src/nexu/cinema_project_imports.py', '_format_srcset', 1, 3, 3).
python_function('src/nexu/cinema_project_imports.py', '_absolutize_external_urls', 2, 1, 8).
python_function('src/nexu/cinema_project_imports.py', '_fetch_meta_assets', 1, 8, 7).
...
python_function('src/nexu/cinema_project_imports.py', '_http_preview_source_context', 1, 9, 8).
python_function('src/nexu/cinema_project_imports.py', '_read_http_preview_html', 1, 2, 1).
python_function('src/nexu/cinema_project_imports.py', '_rewrite_optional_stylesheets', 1, 4, 3).
python_function('src/nexu/cinema_project_imports.py', '_extract_organize_files', 1, 3, 2).
python_function('src/nexu/cinema_project_imports.py', '_ensure_http_preview_marker', 1, 2, 1).
python_function('src/nexu/cinema_project_imports.py', '_build_http_preview_stage0', 1, 3, 12).
...
python_function('src/nexu/cinema_project_imports.py', '_safe_markpact_rel_path', 1, 6, 7).
python_function('src/nexu/cinema_project_imports.py', 'extract_markpact_embedded_files', 1, 5, 7).
python_function('src/nexu/cinema_project_imports.py', '_title_from_markpact_content', 3, 9, 10).
python_function('src/nexu/cinema_project_imports.py', '_write_markpact_embedded_files', 2, 4, 8).
...
python_function('src/nexu/cinema_project_imports.py', 'import_http_project', 2, 12, 17).
python_function('src/nexu/cinema_project_imports.py', 'import_zip_project', 3, 5, 11).
python_function('src/nexu/cinema_project_imports.py', 'import_markpact_project', 3, 12, 16).
python_function('src/nexu/cinema_project_imports.py', '_import_kind_from_id', 1, 5, 1).
python_function('src/nexu/cinema_project_imports.py', '_project_title_from_id', 1, 3, 4).
python_function('src/nexu/cinema_project_imports.py', '_maybe_organize_import_source', 2, 3, 2).
python_function('src/nexu/cinema_project_imports.py', '_finish_import', 1, 12, 21).
...
python_function('src/nexu/cinema_project_imports.py', '_resolve_markpact_path', 3, 4, 4).
python_function('src/nexu/cinema_project_imports.py', '_with_workspace_meta_defaults', 2, 7, 1).
python_function('src/nexu/cinema_project_imports.py', '_compile_meta_fields', 2, 8, 10).
...
python_function('src/nexu/cinema_project_imports.py', 'delete_imported_project', 2, 7, 13).
...
python_function('src/nexu/cinema_project_imports.py', '_load_http_import_meta', 2, 5, 6).
python_function('src/nexu/cinema_project_imports.py', 'promote_cinema_option', 1, 10, 11).
...
python_function('src/nexu/cinema_publish.py', '_service_url_mode', 0, 2, 3).
python_function('src/nexu/cinema_publish.py', '_public_service_url', 1, 4, 3).
...
python_function('src/nexu/cinema_publish.py', '_refresh_service_status', 1, 10, 7).
...
python_function('src/nexu/cinema_publish.py', '_imported_project_ids_in_html', 1, 1, 2).
python_function('src/nexu/cinema_publish.py', '_bundle_imported_source_assets', 3, 5, 11).
python_function('src/nexu/cinema_publish.py', '_prepare_service_directory', 3, 1, 5).
...
python_function('src/nexu/cinema_publish.py', '_create_service_entry', 6, 3, 3).
...
python_function('src/nexu/cinema_publish.py', 'publish_project_service', 3, 5, 16).
...
python_function('src/nexu/cinema_publish.py', '_find_service_entry', 2, 3, 2).
python_function('src/nexu/cinema_publish.py', '_ensure_service_port', 3, 7, 3).
python_function('src/nexu/cinema_publish.py', '_update_service_entry_for_startup', 5, 3, 3).
python_function('src/nexu/cinema_publish.py', 'start_published_service', 2, 6, 13).
python_function('src/nexu/cinema_publish.py', 'stop_published_service', 2, 9, 8).
python_function('src/nexu/cinema_publish.py', '_validate_service_id', 1, 4, 2).
python_function('src/nexu/cinema_publish.py', 'delete_published_service', 2, 11, 10).
python_function('src/nexu/cinema_publish.py', 'delete_published_services_for_project', 2, 12, 7).
python_function('src/nexu/cinema_scope.py', 'cinema_has_offline_baseline', 1, 4, 6).
python_function('src/nexu/cinema_scope.py', 'scope_option_variants', 3, 12, 2).
...
python_function('src/nexu/verify.py', '_scan_capsule_contracts', 2, 3, 6).
...
python_function('tests/test_cinema_dom_patch.py', 'test_build_function_option_patches_xpatches_delete_marks', 0, 8, 3).
python_function('tests/test_cinema_dom_patch.py', 'test_build_function_option_patches_allows_imported_theme_css', 0, 4, 3).
...
python_function('tests/test_cinema_html_validate.py', 'test_imported_html_validation_allows_original_theme_css', 0, 2, 2).
...
python_function('tests/test_cinema_http_preprocess.py', 'test_build_http_llm_context_includes_organize_manifest', 0, 6, 2).
python_function('tests/test_cinema_http_preprocess.py', 'test_load_http_preprocess_artifacts_includes_organize', 1, 5, 6).
...
python_function('tests/test_cinema_http_preprocess.py', 'test_prepare_http_preview_with_shield_keeps_network_shim', 0, 7, 3).
...
python_function('tests/test_cinema_marked_context.py', 'test_inject_scope_style_colors_mixed_keep_delete', 0, 5, 1).
python_function('tests/test_cinema_marked_context.py', 'test_marked_scope_colors_css_differs_by_variant', 0, 5, 1).
python_function('tests/test_cinema_marked_context.py', 'test_inject_scope_style_colors_kadence_heading_inline_strong', 0, 3, 1).
...
python_function('tests/test_cinema_policy.py', 'test_effective_ui_constraints_filters_project_and_scope', 0, 5, 1).
python_function('tests/test_cinema_policy.py', 'test_promote_applies_spatial_deletes_only_for_functions_scope', 0, 6, 1).
python_function('tests/test_cinema_policy.py', 'test_refresh_imported_policy_snapshot_keeps_markpact_separate_from_intract', 1, 4, 6).
python_function('tests/test_cinema_policy.py', 'test_intract_manifest_path_rejects_markpact_readme', 1, 3, 3).
python_function('tests/test_cinema_policy.py', 'test_effective_ui_constraints_ignores_unscoped_when_focus_scope_set', 0, 3, 1).
...
python_function('tests/test_cinema_policy.py', 'test_iteration_ledger_contracts_use_active_project_and_scope', 1, 7, 3).
...
python_function('tests/test_cinema_project_imports.py', 'test_import_zip_with_index_html_organizes_source', 1, 8, 12).
python_function('tests/test_cinema_project_imports.py', 'test_import_zip_without_index_html_skips_organize', 1, 2, 9).
...
python_function('tests/test_cinema_project_imports.py', 'test_import_http_project_fetches_and_migrates', 1, 35, 15).
python_function('tests/test_cinema_project_imports.py', 'test_build_http_preview_stage0_serves_extracted_css_from_cinema', 1, 5, 6).
python_function('tests/test_cinema_project_imports.py', 'test_build_http_preview_stage0_absolutizes_remote_asset_refs', 1, 5, 6).
...
python_function('tests/test_cinema_project_imports.py', 'test_extract_markpact_embedded_files_parses_fenced_blocks', 0, 4, 1).
python_function('tests/test_cinema_project_imports.py', 'test_import_markpact_project_extracts_files_and_activates', 1, 8, 6).
python_function('tests/test_cinema_project_imports.py', 'test_import_markpact_project_rejects_non_markdown', 1, 2, 2).
python_function('tests/test_cinema_project_imports.py', 'test_read_imported_markpact_returns_markdown', 1, 3, 8).
python_function('tests/test_cinema_project_imports.py', 'test_http_stage_matches_import_rejects_calculator_pollution', 1, 4, 2).
python_function('tests/test_cinema_project_imports.py', 'test_http_stage_matches_import_ignores_nexu_shield_selectors', 1, 2, 1).
python_function('tests/test_cinema_project_imports.py', 'test_http_cinema_files_match_import_detects_polluted_alt', 1, 2, 3).
python_function('tests/test_cinema_project_imports.py', 'test_restore_http_import_stages_if_needed_rebuilds_from_seed', 1, 6, 6).
python_function('tests/test_cinema_project_imports.py', 'test_promote_http_import_restores_polluted_alt_before_copy', 1, 7, 8).
python_function('tests/test_cinema_project_imports.py', 'test_activate_http_import_after_calculator_pollution', 1, 5, 7).
...
python_function('tests/test_cinema_publish.py', 'test_publish_creates_service_files', 1, 16, 7).
python_function('tests/test_cinema_publish.py', 'test_list_and_start_stop_service', 1, 13, 9).
python_function('tests/test_cinema_publish.py', 'test_list_migrates_old_localhost_service_urls', 1, 4, 7).
python_function('tests/test_cinema_publish.py', 'test_publish_can_generate_subdomain_public_urls', 2, 4, 3).
python_function('tests/test_cinema_publish.py', 'test_publish_missing_stage_returns_error', 1, 2, 1).
python_function('tests/test_cinema_publish.py', 'test_publish_http_import_bundles_source_assets', 1, 8, 6).
python_function('tests/test_cinema_publish.py', 'test_delete_published_service_removes_registry_and_files', 1, 8, 9).
python_function('tests/test_cinema_publish.py', 'test_delete_unknown_service_returns_error', 1, 2, 1).
...
python_function('tests/test_cinema_scope.py', 'test_http_import_offline_colors_respects_keep_marks', 1, 11, 8).
python_function('tests/test_cinema_scope.py', 'test_http_import_offline_orientation_marks_create_two_column_patch', 1, 7, 8).
python_function('tests/test_cinema_scope.py', 'test_http_import_offline_colors_recolors_kadence_heading_inline', 1, 11, 7).
python_function('tests/test_cinema_scope.py', 'test_http_import_offline_colors_recolors_all_marked_kadence_headings', 1, 8, 6).
python_function('tests/test_cinema_scope.py', 'test_http_import_offline_orientation_two_columns_with_delete_marks', 1, 6, 8).
python_function('tests/test_cinema_scope.py', 'test_http_import_offline_display_keeps_entry_content_headings', 1, 6, 8).
python_function('tests/test_cinema_scope.py', 'test_http_import_offline_shapes_keeps_content_button_radii', 1, 5, 8).
...
python_function('tests/test_cinema_scripts.py', 'test_inject_cinema_shield_skips_lazy_placeholder_imgs', 0, 5, 1).
python_function('tests/test_cinema_scripts.py', 'test_inject_cinema_shield_requires_meaningful_image_alt', 0, 3, 1).
python_function('tests/test_cinema_server.py', 'test_render_server_script_embeds_runtime_context', 0, 80, 5).
...
python_function('tests/test_cinema_server.py', 'test_cinema_player_template_is_externalized', 0, 93, 1).
python_function('tests/test_cinema_server.py', 'test_render_server_script_embeds_project_import_routes', 0, 20, 4).
python_function('tests/test_cinema_server.py', 'test_cinema_server_imports_markpact_upload', 1, 11, 30).
python_function('tests/test_cinema_server.py', 'test_write_cinema_nexu_hooks_includes_import_helpers', 1, 7, 3).
...
python_function('tests/test_intract.py', 'test_parse_toon_manifest', 1, 10, 3).
...
% ── Python Classes ───────────────────────────────────────
python_class('examples/web_app_calculator/cinema/server.py', '_IterateHandler').
python_method('_IterateHandler', '__init__', 4, 1, 20).
python_method('_IterateHandler', '_load_policy_payload', 0, 2, 1).
python_method('_IterateHandler', '_load_goal_contract_lines', 0, 4, 4).
python_method('_IterateHandler', '_merge_ui_constraints', 0, 2, 3).
python_method('_IterateHandler', '_compute_marked_llm_context', 0, 8, 4).
python_method('_IterateHandler', '_apply_scope_fragment', 0, 9, 6).
python_method('_IterateHandler', '_determine_apply_flags', 0, 20, 1).
python_class('examples/web_app_calculator/cinema/server.py', '_IterateHandler').
python_method('_IterateHandler', '__init__', 2, 1, 0).
python_method('_IterateHandler', 'handle', 0, 2, 19).
python_method('_IterateHandler', '_parse_request_data', 0, 32, 11).
python_method('_IterateHandler', '_restore_http_import_stages_if_needed', 0, 6, 8).
python_method('_IterateHandler', '_read_current_stage_html', 0, 5, 8).
python_method('_IterateHandler', '_build_llm_context', 0, 39, 17).
python_method('_IterateHandler', '_determine_iteration_mode', 0, 20, 1).
python_method('_IterateHandler', '_execute_iteration', 0, 4, 3).
python_method('_IterateHandler', '_execute_options_mode', 0, 14, 10).
python_method('_IterateHandler', '_execute_options_llm', 3, 22, 14).
python_method('_IterateHandler', '_execute_full_llm_options', 5, 10, 5).
python_method('_IterateHandler', '_execute_active_workspace_mode', 0, 12, 12).
python_method('_IterateHandler', '_log_iteration', 0, 2, 7).
python_method('_IterateHandler', '_sync_options', 0, 7, 3).
python_method('_IterateHandler', '_append_policy_entry', 0, 3, 1).
python_method('_IterateHandler', '_validate_intract_artifact', 0, 3, 2).
python_method('_IterateHandler', '_save_history_checkpoint', 0, 4, 3).
python_method('_IterateHandler', '_send_response', 0, 1, 7).
python_method('_IterateHandler', '_build_llm_prompt', 0, 36, 11).
python_method('_IterateHandler', '_apply_spatial_patch', 2, 2, 1).
python_method('_IterateHandler', '_finalize_llm_html', 1, 5, 12).
python_method('_IterateHandler', '_call_llm', 2, 8, 13).
python_method('_IterateHandler', '_parse_batch_options', 1, 3, 3).
python_method('_IterateHandler', '_generate_parallel_options', 1, 5, 7).
python_method('_IterateHandler', '_build_batch_options_prompt', 1, 2, 2).
python_method('_IterateHandler', '_call_llm_batch_options', 1, 11, 16).
python_method('_IterateHandler', '_try_llm_patch_options', 1, 20, 20).
python_method('_IterateHandler', '_try_intract_fast_options', 0, 15, 11).
python_method('_IterateHandler', '_try_function_patch_options', 0, 7, 14).
python_method('_IterateHandler', '_llm_option_variants', 3, 8, 5).
python_method('_IterateHandler', '_write_option_files', 2, 5, 7).
...
python_method('CustomHTTPRequestHandler', '_handle_get_root_redirect', 0, 2, 4).
python_method('CustomHTTPRequestHandler', '_handle_get_policy', 0, 5, 12).
python_method('CustomHTTPRequestHandler', '_handle_get_projects_catalog', 0, 2, 8).
python_method('CustomHTTPRequestHandler', '_handle_get_projects_active', 0, 2, 8).
python_method('CustomHTTPRequestHandler', '_handle_get_services_catalog', 0, 2, 8).
python_method('CustomHTTPRequestHandler', '_handle_get_health', 0, 3, 9).
python_method('CustomHTTPRequestHandler', '_handle_get_llm_status', 0, 2, 8).
python_method('CustomHTTPRequestHandler', '_handle_get_llm_traces', 0, 3, 11).
python_method('CustomHTTPRequestHandler', '_handle_get_imported_project_route', 0, 5, 11).
python_method('CustomHTTPRequestHandler', '_handle_get_llm_trace', 0, 4, 11).
python_method('CustomHTTPRequestHandler', '_handle_get_history', 0, 2, 8).
python_method('CustomHTTPRequestHandler', '_handle_get_export_markpact', 0, 7, 11).
python_method('CustomHTTPRequestHandler', 'do_GET', 0, 9, 11).
...
sumd_workflow_step('quality', 11, 'src/nexu/cinema_project_imports.py \').
sumd_workflow_step('quality', 12, 'src/nexu/cinema_projects.py \').
sumd_workflow_step('quality', 13, 'src/nexu/cinema_scripts.py \').
sumd_workflow_step('quality', 14, 'src/nexu/cinema_publish.py \').
sumd_workflow_step('quality', 15, 'src/nexu/cinema_offline_options.py \').
sumd_workflow_step('quality', 16, 'src/nexu/cinema_options_cache.py \').
...
sumd_workflow_step('quality', 28, 'tests/test_cinema_dom_patch.py \').
sumd_workflow_step('quality', 29, 'tests/test_cinema_project_ir.py \').
sumd_workflow_step('quality', 30, 'tests/test_cinema_project_imports.py \').
sumd_workflow_step('quality', 31, 'tests/test_cinema_projects.py \').
sumd_workflow_step('quality', 32, 'tests/test_cinema_scripts.py \').
sumd_workflow_step('quality', 33, 'tests/test_cinema_publish.py \').
sumd_workflow_step('quality', 34, 'tests/test_cinema_offline_options.py \').
sumd_workflow_step('quality', 35, 'tests/test_cinema_options_cache.py \').
sumd_workflow_step('quality', 36, 'tests/test_cinema_ui_patch.py \').
sumd_workflow_step('quality', 37, 'tests/test_fast_delivery.py').
...
sumd_workflow_step('publish', 2, 'echo "🔢 Bumping patch version..."').
sumd_workflow_step('publish', 3, '$(MAKE) bump-patch').
sumd_workflow_step('publish', 4, 'echo "🔨 Rebuilding package with new version..."').
sumd_workflow_step('publish', 5, '$(MAKE) build').
sumd_workflow_step('publish', 6, 'echo "📦 Publishing to PyPI..."').
...
sumd_workflow_step('publish', 11, 'echo "✓ Published to PyPI"').
```

## Call Graph

*436 nodes · 500 edges · 63 modules · CC̄=4.4*
...
| `_build_llm_context` *(in examples.web_app_calculator.cinema.server._IterateHandler)* | 39 ⚠ | 0 | 45 | **45** |
...
| `_try_llm_patch_options` *(in examples.web_app_calculator.cinema.server._IterateHandler)* | 20 ⚠ | 0 | 35 | **35** |
| `main` *(in examples.web_app_dashboard.run)* | 2 | 0 | 35 | **35** |

```toon markpact:analysis path=project/calls.toon.yaml
# code2llm call graph | /home/tom/github/semcod/nexu
# generated in 0.26s
# nodes: 436 | edges: 500 | modules: 63
# CC̄=4.4
...
MODULES:
  examples.calculator_demo.scientific_calculator_demo  [1 funcs]
    main  CC=2  out:23
  examples.calculator_demo.scientific_calculator_demo2  [2 funcs]
    main  CC=2  out:17
    print_code  CC=1  out:6
  examples.lane_integration.realtime_lane_nexu_sync  [1 funcs]
    simulate_realtime_sync  CC=2  out:10
  examples.markpact_integration.nexu_markpact_exporter  [1 funcs]
    main  CC=3  out:22
  ...
  examples.runner.run_examples  [2 funcs]
    main  CC=2  out:1
  ...
  examples.web_app_calculator.cinema.server  [114 funcs]
    _handle_get_export_markpact  CC=7  out:30
    _handle_get_history  CC=2  out:14
    _handle_get_imported_project_route  CC=5  out:17
    _handle_get_llm_status  CC=2  out:14
    _handle_get_llm_trace  CC=4  out:19
    _handle_get_llm_traces  CC=3  out:18
    _handle_get_policy  CC=5  out:19
    _handle_get_projects_active  CC=2  out:14
    _handle_get_projects_catalog  CC=2  out:14
    _handle_get_services_catalog  CC=2  out:14
  ...
  src.nexu.cinema_baseline_contracts  [2 funcs]
    ensure_capsule_intract_yaml  CC=9  out:25
    merge_calculator_baselines  CC=5  out:5
  src.nexu.cinema_dom_patch  [1 funcs]
    build_function_option_patches  CC=1  out:1
  src.nexu.cinema_history  [5 funcs]
    ensure_initial_checkpoint  CC=3  out:4
    ledger_archive_for_display  CC=5  out:16
    list_history_checkpoints  CC=1  out:3
    restore_history_checkpoint  CC=8  out:18
    save_history_checkpoint  CC=4  out:19
  src.nexu.cinema_html  [1 funcs]
    ensure_html_document_closure  CC=5  out:3
  src.nexu.cinema_html_validate  [2 funcs]
    filter_valid_option_batch  CC=9  out:6
    prepare_cinema_html_document  CC=2  out:2
  src.nexu.cinema_http_preprocess  [27 funcs]
  ...
  src.nexu.cinema_iterate  [1 funcs]
    build_iterate_response_payload  CC=11  out:7
  ...
  src.nexu.cinema_llm_contracts  [2 funcs]
  ...
  src.nexu.cinema_offline_options  [1 funcs]
    write_goal_options_offline  CC=13  out:15
  src.nexu.cinema_policy  [17 funcs]
    ...
    promote_applies_spatial_deletes  CC=2  out:3
  ...
  src.nexu.cinema_projects  [5 funcs]
    activate_example_project  CC=2  out:13
    delete_example_project  CC=14  out:17
    find_nexu_repo_root  CC=5  out:4
    list_project_catalog  CC=3  out:3
  ...
  src.nexu.fast_delivery.options  [3 funcs]
    read_cached_options  CC=11  out:17
    read_option_files  CC=3  out:3
    store_options_cache  CC=3  out:4
  src.nexu.fast_delivery.router  [1 funcs]
    is_options_ready_status  CC=2  out:1
...
EDGES:
  ...
  examples.lane_integration.realtime_lane_nexu_sync.simulate_realtime_sync → scripts.ci-cinema-smoke.print
  examples.markpact_integration.nexu_markpact_exporter.main → scripts.ci-cinema-smoke.print
  ...
  examples.calculator_demo.scientific_calculator_demo.main → scripts.ci-cinema-smoke.print
  examples.calculator_demo.scientific_calculator_demo.main → src.nexu.init_project.init_project
  examples.calculator_demo.scientific_calculator_demo.main → src.vico.freeze.freeze_project
  examples.calculator_demo.scientific_calculator_demo.main → src.nexu.capsule.create_capsule
  examples.calculator_demo.scientific_calculator_demo2.print_code → scripts.ci-cinema-smoke.print
  examples.calculator_demo.scientific_calculator_demo2.main → examples.calculator_demo.scientific_calculator_demo2.print_code
  examples.calculator_demo.scientific_calculator_demo2.main → src.nexu.init_project.init_project
  examples.calculator_demo.scientific_calculator_demo2.main → src.vico.freeze.freeze_project
  examples.calculator_demo.scientific_calculator_demo2.main → src.nexu.capsule.create_capsule
  examples.calculator_demo.scientific_calculator_demo2.main → src.nexu.iterate.iterate_capsule
  ...
  examples.web_app_calculator.cinema.nexu_hooks.import_project_from_http → src.nexu.cinema_project_imports.import_http_project
  examples.web_app_calculator.cinema.nexu_hooks.import_project_from_markpact → src.nexu.cinema_project_imports.import_markpact_project
  examples.web_app_calculator.cinema.nexu_hooks.delete_imported → src.nexu.cinema_projects.find_nexu_repo_root
```
