...
workflow[name="quality"] {
  trigger: manual;
  step-1: run cmd=ruff check src/nexu/cinema.py src/nexu/cinema_server.py src/nexu/verify.py src/nexu/intract_adapter.py tests/test_cinema_server.py;
}
...
pipeline:
  ...
  stages:
    ...
    - name: touched-lint
      run: ruff check src/nexu/cinema.py src/nexu/cinema_server.py src/nexu/verify.py src/nexu/intract_adapter.py tests/test_cinema_server.py
...
*213 nodes · 359 edges · 43 modules · CC̄=3.7*
...
| `create_capsule` *(in src.nexu.capsule)* | 8 | 7 | 24 | **31** |
| `project_root` *(in src.nexu.paths)* | 1 | 28 | 3 | **31** |

```toon markpact:analysis path=project/calls.toon.yaml
# code2llm call graph | /home/tom/github/semcod/nexu
# generated in 0.10s
# nodes: 213 | edges: 359 | modules: 43
# CC̄=3.7
...
MODULES:
  ...
  src.nexu.cinema  [9 funcs]
    ...
    build_intract_policy_snapshot  CC=11  out:29
    format_intract_v1_line  CC=3  out:1
    generate_cinema_player  CC=1  out:19
  ...
  src.nexu.cinema_markpact  [2 funcs]
    ...
    build_markpact_readme  CC=10  out:17
  src.nexu.cinema_policy  [27 funcs]
    ...
    cinema_model_label  CC=2  out:3
    effective_ui_constraints_from_ledger  CC=24  out:17
  ...
  src.nexu.cinema_publish  [14 funcs]
    _http_ok  CC=2  out:1
    _load_registry  CC=3  out:6
    _port_open  CC=2  out:1
    _refresh_service_status  CC=3  out:1
    _registry_path  CC=1  out:1
    _save_registry  CC=1  out:5
    _service_alive  CC=6  out:8
    _slug_service_id  CC=4  out:2
    _write_service_readme  CC=6  out:16
...
# code2llm | 77f 7670L | python:57,yaml:10,shell:3,json:2,toml:1,txt:1,yml:1 | 2026-05-31
# generated in 0.02s
# CC̅=3.7 | critical:4/253 | dups:0 | cycles:0

HEALTH[4]:
  🟡 CC    activate_example_project CC=16 (limit:15)
  🟡 CC    effective_ui_constraints_from_ledger CC=24 (limit:15)
  🟡 CC    publish_project_service CC=21 (limit:15)
...
PIPELINES[63]:
  ...
  [2] Src [main]: main → init_project → ensure_project_dirs → nexu_dir
      PURITY: 100% pure
  [3] Src [main]: main → run_example → init_project → ensure_project_dirs → ...(1 more)
      PURITY: 100% pure
  [4] Src [main]: main → print_code
      PURITY: 100% pure
  [5] Src [main]: main
      PURITY: 100% pure
  [6] Src [main]: main → init_project → ensure_project_dirs → nexu_dir
      PURITY: 100% pure
  [7] Src [list_users]: list_users
      PURITY: 100% pure
  [8] Src [preview_menu_icons]: preview_menu_icons
      PURITY: 100% pure
  [9] Src [main]: main → init_project → ensure_project_dirs → nexu_dir
      PURITY: 100% pure
  [10] Src [render_dashboard]: render_dashboard
      PURITY: 100% pure
  [11] Src [render_dashboard]: render_dashboard
      PURITY: 100% pure
  [12] Src [main]: main
      PURITY: 100% pure
  [13] Src [list_history_checkpoints]: list_history_checkpoints → _load_index → history_index_path → history_dir
      PURITY: 100% pure
  [14] Src [restore_history_checkpoint]: restore_history_checkpoint → project_root
      PURITY: 100% pure
  [15] Src [ledger_archive_for_display]: ledger_archive_for_display → _ledger_snapshot
      PURITY: 100% pure
  ...
  [23] Src [to_dict]: to_dict
      PURITY: 100% pure
  [24] Src [repair_cinema_html_files]: repair_cinema_html_files → write_cinema_inject_files
      PURITY: 100% pure
  [25] Src [_apply_promotion_from_mcp]: _apply_promotion_from_mcp → build_promotion_plan → load_capsule → read_yaml
      PURITY: 100% pure
  [26] Src [simulate_realtime_sync]: simulate_realtime_sync
      PURITY: 100% pure
  [27] Src [init]: init → project_root
      PURITY: 100% pure
  [28] Src [freeze]: freeze → project_root
      PURITY: 100% pure
  [29] Src [capsule_create]: capsule_create → project_root
      PURITY: 100% pure
  [30] Src [capsule_list]: capsule_list → project_root
      PURITY: 100% pure
  [31] Src [capsule_status_command]: capsule_status_command → project_root
      PURITY: 100% pure
  [32] Src [capsule_iterate]: capsule_iterate → project_root
      PURITY: 100% pure
  [33] Src [capsule_blueprint]: capsule_blueprint → project_root
      PURITY: 100% pure
  [34] Src [capsule_export_prompt]: capsule_export_prompt → project_root
      PURITY: 100% pure
  [35] Src [capsule_diff]: capsule_diff → project_root
      PURITY: 100% pure
  [36] Src [capsule_drift]: capsule_drift → project_root
      PURITY: 100% pure
  [37] Src [capsule_verify]: capsule_verify → project_root
      PURITY: 100% pure
  [38] Src [capsule_plan]: capsule_plan → project_root
      PURITY: 100% pure
  [39] Src [capsule_runtime]: capsule_runtime → project_root
      PURITY: 100% pure
  [40] Src [capsule_report]: capsule_report → project_root
      PURITY: 100% pure
  [41] Src [capsule_journal]: capsule_journal → project_root
      PURITY: 100% pure
  [42] Src [capsule_orchestrate]: capsule_orchestrate → project_root
      PURITY: 100% pure
  [43] Src [capsule_review]: capsule_review → project_root
      PURITY: 100% pure
  [44] Src [capsule_bundle]: capsule_bundle → project_root
      PURITY: 100% pure
  [45] Src [capsule_promote]: capsule_promote → project_root
      PURITY: 100% pure
  [46] Src [mcp_tools]: mcp_tools
      PURITY: 100% pure
  [47] Src [mcp_serve]: mcp_serve → project_root
      PURITY: 100% pure
  [48] Src [to_public_dict]: to_public_dict
      PURITY: 100% pure
  [49] Src [list_project_catalog]: list_project_catalog
      PURITY: 100% pure
  [50] Src [activate_example_project]: activate_example_project → _resolve_source_cinema
      PURITY: 100% pure

LAYERS:
  src/                            CC̄=3.8    ←in:0  →out:0
  │ !! cinema_policy              624L  0C   29m  CC=24     ←3
  │ !! cinema_scripts             545L  0C    5m  CC=6      ←3
  │ mcp_server                 393L  0C   13m  CC=6      ←1
  │ cli                        379L  0C   23m  CC=4      ←0
  │ !! cinema_projects            359L  1C    9m  CC=16     ←0
  │ !! cinema_publish             339L  0C   15m  CC=21     ←0
  │ verify                     317L  0C   14m  CC=12     ←7
  │ cinema_history             244L  0C   13m  CC=8      ←1
  │ orchestrate                232L  0C    6m  CC=13     ←2
  │ cinema                     186L  0C    9m  CC=11     ←2
  ...
  │ cinema_markpact             95L  0C    3m  CC=10     ←1
  ...
  │
  ── zero ──
     src/nexu/__main__.py                      0L
     src/nexu/diff.py                          0L
     src/nexu/drift.py                         0L
     src/nexu/freeze.py                        0L
     src/nexu/git.py                           0L
     src/nexu/hashing.py                       0L
     src/nexu/intract.py                       0L
     src/nexu/models.py                        0L
     src/nexu/status.py                        0L

COUPLING:
                                                  src.nexu                     src.nexu                     examples   examples.web_app_dashboard  examples.web_app_calculator
                     src.nexu                           ──                           62                          ←21                           ←9                           ←5  hub
                     src.nexu                           12                           ──                           ←5                           ←1                           ←1  hub
                     examples                           21                            5                           ──                                                            !! fan-out
   examples.web_app_dashboard                            9                            1                                                        ──                               !! fan-out
  examples.web_app_calculator                            5                            1                                                                                     ──
  CYCLES: none
  HUB: src.nexu/ (fan-in=47)
  HUB: src.nexu/ (fan-in=69)
  ...
  SMELL: src.nexu/ fan-out=12 → split needed
...
# redup/duplication | 2 groups | 58f 7046L | 2026-05-31
...
DUPLICATES[2] (ranked by impact):
  ...
  [3e7f254259144cfa]   STRU  option_previews_are_distinct  L=4 N=2 saved=4 sim=1.00
      src/nexu/cinema_policy.py:119-122  (option_previews_are_distinct)
      src/nexu/cinema_policy.py:125-128  (stage_files_are_distinct)
...
REFACTOR[2] (ranked by priority):
  ...
  [2] ○ extract_function   → src/nexu/utils/option_previews_are_distinct.py
...
METRICS-TARGET:
  dup_groups:  2 → 0
  saved_lines: 78 lines recoverable
```

### Evolution / Churn (`project/evolution.toon.yaml`)

```toon markpact:analysis path=project/evolution.toon.yaml
# code2llm/evolution | 226 func | 37f | 2026-05-31
# generated in 0.00s

NEXT[7] (ranked by impact):
  [1] !! SPLIT           src/nexu/cinema_policy.py
      WHY: 624L, 0 classes, max CC=24
      EFFORT: ~4h  IMPACT: 14976

  [2] !! SPLIT           src/nexu/cinema_scripts.py
      WHY: 545L, 0 classes, max CC=6
      EFFORT: ~4h  IMPACT: 3270

  [3] !  SPLIT-FUNC      publish_project_service  CC=21  fan=27
  ...
  [6] !  SPLIT-FUNC      effective_ui_constraints_from_ledger  CC=24  fan=8
...
RISKS[3]:
  ⚠ Splitting src/nexu/cinema_policy.py may break 29 import paths
