...
def write_cinema_nexu_hooks(cinema_dir: Path, root: Path, name: str) -> None:
    ...
    hooks = '''"""Generated by nexu cinema — do not edit manually."""
from pathlib import Path
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="side-panel">
            ...
            <div class="side-header">2. Mark workspace (after promote)</div>
            <button type="button" class="btn-review" id="btn-review-mode" onclick="toggleElementReviewMode()">🖱️ Drag selection (default)</button>
    ...
    <script>
        ...
        function promoteAlt(altSrc, optName) {
            ...
            .then(data => {
                ...
                syncReviewModeToFrames();
                addChatLog('system', `🌟 <strong>Promoted ${optName} → workspace saved.</strong> Drag to mark (left = keep, right = remove), then Apply marks.`);
                updateWorkflowUI();
                refreshHistory();
        ...
        async function copyStateToClipboard() {
            ...
            try {
                ...
                addChatLog('system', '📋 <strong>Session JSON copied</strong> (history, pending goal, review mode, HTML previews).');
            } catch (err) {
